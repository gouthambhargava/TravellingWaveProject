...
loadDataFlag = 1; % if 1 is selected, pre-analyzed data will be loaded

analysisMethod = 'hilbert';
displayTWData(gridType,subjectName,expDate,protocolName,dataPath,sPos,oriPos,selectedElectrodes,analysisMethod,freqRangeList,stimPeriod,waveLengthLimit,loadDataFlag);