...
dataPath = 'F:\monkeyData\data'; % change the data path 
% dataPath = 'N:\Projects\Bhargava_TravelingWaveProject\data';
gridType = 'Microelectrode';

subjectName='alpaH'; expDate = '210817'; protocolName = 'GRF_002'; selectedElectrodes = [1 41 81]; freqRangeList{1} = [20 35]; freqRangeList{2} = [40 60];
...
displayTWData(gridType,subjectName,expDate,protocolName,dataPath,sPos,oriPos,selectedElectrodes,analysisMethod,freqRangeList,waveLengthLimit);