Travelling wave project - to charactarize travelling waves in gamma (30-60Hz) from microelectrode recordings in NPH visual cortex. run 'runDisplayTWData.m'

The following programs should be downloaded and added to Matlab path

    Chronux: download from http://chronux.org/
    ...
    Script for Watsons U2 test: https://github.com/pierremegevand/watsons_u2
...
Glossary of scripts
    ...
    generateFig1-6 - generate respective figures
