...
% Modified From: https://in.mathworks.com/matlabcentral/fileexchange/72729-topographic-eeg-meg-plot?#functions_tab
...
%                 theta and radius - available in .../Programs/ProgramsMAP/Montages/actiCap64.mat
...
%                 the direction of propagation of waves is to be plotted.                 
% - direction:    Vector of direction values for all channels
% - interpPoints:(Optional, default: 1000) No. of interpolation    
%                 points. The lower N, the lower resolution and faster computation.    




    if nargin < 6; interpPoints = 1000;  end
